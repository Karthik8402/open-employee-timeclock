...
// include '../functions.php'; // Already included via config.inc.php
...
// DB Connection handled by config.inc.php shim
global $db;
if (!isset($db) && !isset($GLOBALS['db_hostname'])) {
    // Fallback if config not loaded? But it should be.
...
echo "<script language=\"javascript\" src=\"../js/pnguin.js\"></script>\n";
echo "</head>\n";
